function plot_stim_value_one_day(subj,block,time_lock,ERP_fit,elecs_to_plot)
...
for elec = good_elecs
    ...
    %    legend('Neutral','Positive')   
     ...
     elseif ERP_fit == 1
%         
        [power_mean, power_se, m, col] = fit_ERP(subj,block,dat,-0.5,ps,3,time_lock);
